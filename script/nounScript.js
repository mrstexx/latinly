...
var prvaDeklinacija = ["A", "AE", "AE", "ARUM", "AE", "IS", "AM", "AS", "A", "AE", "A", "IS"];
...
//        var extension = secondInput.value.toUpperCase().substr(secondInput.value.length - 2, 2);
        ...
        if(type.value === "1. Deklinacija") {
            deklinacija(firstInput.value.toUpperCase(), secondInput.value.toUpperCase(), selection.value, 1);
        }

//        extension = secondInput.value.toUpperCase().substr(secondInput.value.length - 1, 2);

        if(type.value === "2. Deklinacija") {
            deklinacija(firstInput.value.toUpperCase(), secondInput.value.toUpperCase(), selection.value, 2);
        }
        
 //       extension = secondInput.value.toUpperCase().substr(secondInput.value.length - 2, 2);
        
        if(type.value === "3. Deklinacija") {
            deklinacija(firstInput.value.toUpperCase(), secondInput.value.toUpperCase(), selection.value, 3);
        }

//        extension = secondInput.value.toUpperCase().substr(secondInput.value.length - 2, 2);

        if(type.value === "4. Deklinacija") {
            deklinacija(firstInput.value.toUpperCase(), secondInput.value.toUpperCase(), selection.value, 4);
        }

//        extension = secondInput.value.toUpperCase().substr(secondInput.value.length - 2, 2);

        if(type.value === "5. Deklinacija") {
            deklinacija(firstInput.value.toUpperCase(), secondInput.value.toUpperCase(), selection.value, 5);
        }
...
function deklinacija(a1, a2, a3, broj) {
    ...
    if(broj === 1) {
        ...
        for(var i = 0; i < 12; i++) {
            field[i].textContent = osnova + prvaDeklinacija[i];
        }
    }
